...
@Autonomous(name="RightAutoState")
public class AutoRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
      ...
      //  odometryDrive.goToPositionForward(0,51.5,.5,0,0.05); //ADD BACK IN AT THE END!!!!!!!!!!!! this is removed for more efficient testing
        ...
        final double turntablespeed = 1;
        final int elbowPos = 84;//was 84  //78
        final double winchHeight = 47.56; //was 49.2, was 48.56    44.1
        final double angleToPol = 39; //was 39.0
      ...
      //  odometryDrive.goToPositionForward(0,45.5,.69,0,4); //ADD BACK IN AT THE END!!!!!!!!!!!! this is removed for more efficient testing
  ...
  //          while ((/*robot.turnTable.isBusy()*/ (!armDriverPos.turnTableCloseEnough() || elbowPIDThread.isBusy())) && opModeIsActive() /*|| (Math.abs((target = robot.elbow.getTargetPosition()) - (current = robot.elbow.getCurrentPosition())) > 2) */ ) {
           ...
           // sleep(100);//needed was 150
            ...
            armDriverPos.turnTableToPosition(turntablespeed, -85, false);
            timer.reset();
        ...
        if (alphaColor == RobotHardware.PowerPlayPipeline.MarkerPosition.Green) {
            ...
            odometryDrive.goToPositionForward(0,46,0.8,0,1);
     ...
     //           idle();
      //      }
            odometryDrive.goToPositionSide(-20,51.5,0.75,0,1);
            odometryDrive.goToPositionForward(-20,50,0.5,0,1);
            ...
            //    idle();
            //}
            odometryDrive.goToPositionSide(26,51.5,1,0,1);
