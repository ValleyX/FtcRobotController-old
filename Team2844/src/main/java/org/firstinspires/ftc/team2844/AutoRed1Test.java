...
public class AutoRed1Test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        armDriverPos.elbowToPosition(elbowUpSpeed, 74,false);
        //sleep(250);
        ...
        armDriverPos.turnTableToPosition(turnTableSpeed, -37, false);
        sleep(500);
        ...
        armDriverPos.turnTableToPosition(turnTableSpeed, 83, false);
