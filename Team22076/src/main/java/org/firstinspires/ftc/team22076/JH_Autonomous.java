...
public class JH_Autonomous extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
       ...
       //sleep(5000);
        ...
        sleep(1500);
        eDrive.driveStraight(.25, -7, -45,5);
