...
public class JH_Auto_Blue_Left extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
       ...
       //sleep(5000);
        ...
        eDrive.driveStraight(.25, 9.5 , -41,5);
        ...
        Robot.gripservo.setPosition(0.05);  //.25 open .7 is close
        sleep(1500);
        ...
        eDrive.driveStraight(.25, -12, -41,5);
