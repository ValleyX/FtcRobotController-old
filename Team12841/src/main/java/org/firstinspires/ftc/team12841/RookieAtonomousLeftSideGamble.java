...
@Autonomous(name = "RookieAutonomousLeftSideGamble")
public class RookieAtonomousLeftSideGamble extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (robotHardware.pipeline.markerPos == RobotHardware.SkystoneDeterminationPipeline.MarkerPos.Red)
        {
            ...
            Gyro.turnToHeading(0.3, -90, 10000000); //here
            liftdriver.moveInches(4.5, .5);
